...
public class Operations {
    ...
    public static Operation4<RequestResource, Long, Long, Long, Long> requestResources() {
     ...
     public static Operation5<BatchRequest,Long, Long, Long, Long, Long> requestBatch() {
        return new Operation5<BatchRequest,Long, Long, Long, Long, Long>() {
            @Override
            public BatchRequest generate(Long id,Long _machines, Long numCpus, Long memInMbs,
                    Long timeToHoldResourceInMilliSecs) {
                return new BatchRequest(id, _machines.intValue(), numCpus.intValue(),
                        memInMbs.intValue(),
                        timeToHoldResourceInMilliSecs.intValue());
            }
        };
